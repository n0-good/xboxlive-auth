...
export declare const live: {
    ...
    authenticate: (credentials: LiveCredentials, proxy?: Proxy | undefined) => Promise<LiveAuthResponse>;
...
export declare const xbl: {
    ...
    exchangeRpsTicketForUserToken: (rpsTicket: string, preamble?: "d" | "t", additionalHeaders?: Record<string, string>, proxy?: Proxy | undefined) => Promise<XBLExchangeRpsTicketResponse>;
    exchangeTokensForXSTSToken: (tokens: XBLTokens, options?: XBLExchangeTokensOptions, additionalHeaders?: Record<string, string>, proxy?: Proxy | undefined) => Promise<XBLExchangeTokensResponse>;
