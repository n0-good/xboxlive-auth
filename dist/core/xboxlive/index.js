...
const getProxyAgent = (proxy) => proxy ? ({
...
const exchangeRpsTicketForUserToken = (rpsTicket, preamble = 't', additionalHeaders = {}, proxy) => __awaiter(void 0, void 0, void 0, function* () {
    const match = rpsTicket.match(/^([t|d]=)/g);
    if (match === null) {
        rpsTicket = `${preamble}=${rpsTicket}`;
    }
    const response = yield axios_1.default(Object.assign({ url: config_1.default.urls.userAuthenticate, method: 'POST', headers: utils_1.getBaseHeaders(Object.assign(Object.assign({}, XBLAdditionalHeaders), additionalHeaders)), data: {
...
const exchangeTokensForXSTSToken = (tokens, options = {}, additionalHeaders = {}, proxy) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield axios_1.default(Object.assign({ url: config_1.default.urls.XSTSAuthorize, method: 'POST', headers: utils_1.getBaseHeaders(Object.assign(Object.assign({}, XBLAdditionalHeaders), additionalHeaders)), data: {
