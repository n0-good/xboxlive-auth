...
const authenticate = (credentials, proxy) => __awaiter(void 0, void 0, void 0, function* () {
    const preAuthResponse = yield exports.preAuth();
    const response = yield axios_1.default(Object.assign({ url: preAuthResponse.matches.urlPost, method: 'POST', headers: utils_1.getBaseHeaders({
            'Content-Type': 'application/x-www-form-urlencoded',
        ...
        }), maxRedirects: 0, validateStatus: status => status === 302 || status === 200 }, getProxyAgent(proxy)))
        .then(res => {
        if (res.status === 200) {
