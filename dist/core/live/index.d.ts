import { LiveAuthResponse, LiveCredentials, LivePreAuthResponse, LivePreAuthOptions, Proxy } from '../..';
...
export declare const authenticate: (credentials: LiveCredentials, proxy?: Proxy | undefined) => Promise<LiveAuthResponse>;
